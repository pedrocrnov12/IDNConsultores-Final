...
const ComparisonTable2: React.FC<{ planName: string; prices: string[]; features: string[] }> = ({
  planName,
  prices,
  features,
}) => {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg mb-8 md:w-96 lg:w-120 mx-auto sm:px-9 lg:px-0">
      ...
      <div className="px-12 max-h-60 overflow-y-auto text-center">
