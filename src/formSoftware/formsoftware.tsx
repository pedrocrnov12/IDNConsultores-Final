    ...
    <form onSubmit={handleSubmit} className="bg-gray-300 rounded-lg p-4">
      ...
      >
       <option value="">Seleccione un plan</option>
        <option value="Software de Gestión Comercial, Lógistico y Operativo  Estandar">Software de Gestión Comercial, Lógistico y Operativo  Estandar</option>
        <option value="Software de Gestión Comercial, Lógistico y Operativo  Profesional">Software de Gestión Comercial, Lógistico y Operativo Profesional</option>
      </select>
