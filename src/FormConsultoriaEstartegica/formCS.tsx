  ...
  return (
    <div className="bg-gray-300 rounded-lg p-4 shadow-md max-w-md mx-auto">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label htmlFor="plan" className="block text-lg font-semibold">
          Plan para cotizar:
        </label>
        <select
          id="plan"
        ...
        >
          ...
          <option value="Automatización y Digitalización de Procesos">Automatización y Digitalización de Procesos</option>
