  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="bg-gray-300 rounded-lg p-4">
      ...
      >
        ...
        <option value="Innovación Empresarial">Innovación Empresarial</option>
        <option value="Estrategias Digitales de Venta y Comercialización">Estrategias Digitales de Venta y Comercialización</option>
